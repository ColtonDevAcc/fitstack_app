...
abstract class _$BasalEnergyLogCWProxy {
  BasalEnergyLog id(String? id);

  BasalEnergyLog createdAt(DateTime createdAt);

  BasalEnergyLog updatedAt(DateTime? updatedAt);

  BasalEnergyLog userId(String? userId);

  BasalEnergyLog type(HealthDataType type);

  BasalEnergyLog value(num value);
...
class _$BasalEnergyLogCWProxyImpl implements _$BasalEnergyLogCWProxy {
  ...
  @override
  BasalEnergyLog id(String? id) => this(id: id);

  @override
  BasalEnergyLog createdAt(DateTime createdAt) => this(createdAt: createdAt);

  @override
  BasalEnergyLog updatedAt(DateTime? updatedAt) => this(updatedAt: updatedAt);

  @override
  BasalEnergyLog userId(String? userId) => this(userId: userId);

  @override
  BasalEnergyLog type(HealthDataType type) => this(type: type);

  @override
  BasalEnergyLog value(num value) => this(value: value);
