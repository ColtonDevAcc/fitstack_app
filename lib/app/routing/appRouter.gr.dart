...
class AppRouter extends _i9.RootStackRouter {
  ...
  final Map<String, _i9.PageFactory> pagesMap = {
    ...
    RelationshipView.name: (routeData) {
      return _i9.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i8.RelationshipView());
    }
  };
  ...
  List<_i9.RouteConfig> get routes => [
        ...
        _i9.RouteConfig(Login.name, path: 'auth'),
        _i9.RouteConfig(Signup.name, path: 'auth/signup'),
        _i9.RouteConfig(Main_View.name, path: '/mainView', children: [
          _i9.RouteConfig(DashboardView.name,
              path: 'DashBoard', parent: Main_View.name),
          _i9.RouteConfig(NutritionView.name,
              path: 'Nutrition', parent: Main_View.name),
          _i9.RouteConfig(WorkoutView.name,
              path: 'Workout', parent: Main_View.name),
          _i9.RouteConfig(SettingsView.name,
              path: 'Settings', parent: Main_View.name),
          _i9.RouteConfig(RelationshipView.name,
              path: 'Relationship', parent: Main_View.name)
        ])
      ];
}
...
class RelationshipView extends _i9.PageRouteInfo<void> {
  const RelationshipView() : super(RelationshipView.name, path: 'Relationship');
