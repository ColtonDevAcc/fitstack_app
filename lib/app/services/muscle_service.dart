...
class MuscleService {
  List<Muscle> muscleList = [
    Muscle(
      ...
      type: PrimaryMuscleGroups.empty,
      svgPath: parseSvgPath(
    ...
    Muscle(
      name: 'left forearm',
      type: PrimaryMuscleGroups.forearms,
      svgPath: parseSvgPath(
    ...
    Muscle(
      name: 'bicept',
      type: PrimaryMuscleGroups.biceps,
      svgPath: parseSvgPath(
    ...
    Muscle(
      name: kDebugMode ? 'shoulder left' : "shoulders",
      type: PrimaryMuscleGroups.deltoids,
      svgPath: parseSvgPath(
    ...
    Muscle(
      name: 'chest',
      type: PrimaryMuscleGroups.pectorals,
      svgPath: parseSvgPath(
    ...
    Muscle(
      name: 'obliques',
      type: PrimaryMuscleGroups.obliques,
      svgPath: parseSvgPath(
    ...
    Muscle(
      name: 'outterQuad',
      type: PrimaryMuscleGroups.vastusLateralist,
      svgPath: parseSvgPath(
    ...
    Muscle(
      name: 'quads',
      type: PrimaryMuscleGroups.quadriceps,
      svgPath: parseSvgPath(
    ...
    Muscle(
      name: 'calves',
      type: PrimaryMuscleGroups.calves,
      svgPath: parseSvgPath(
    ...
    Muscle(
      name: 'abdominal',
      type: PrimaryMuscleGroups.abdominals,
      svgPath: parseSvgPath(
    ...
    Muscle(
      name: 'FrontRightInnerForearm',
      type: PrimaryMuscleGroups.brachioradialis,
      svgPath: parseSvgPath(
    ...
    Muscle(
      name: kDebugMode ? 'shoulder right' : "shoulders",
      type: PrimaryMuscleGroups.deltoids,
      svgPath: parseSvgPath(
    ...
    Muscle(
      name: kDebugMode ? 'Traps Left' : "traps",
      type: PrimaryMuscleGroups.trapezius,
      svgPath: parseSvgPath(
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (Muscle muscle in muscleList) {
      Color getMuscleColor(Muscle muscle) {
        ...
        } else if (muscle.type == PrimaryMuscleGroups.empty) {
